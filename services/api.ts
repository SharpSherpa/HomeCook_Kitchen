import { MenuItem, ContactInfo, User, UserRole, Order, OrderStatus, CartItem, UserCredentials } from '../types';
import { MOCK_MENU_ITEMS, MOCK_CONTACT_INFO } from '../constants';
